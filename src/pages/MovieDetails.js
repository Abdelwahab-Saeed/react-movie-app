...
export default function MovieDetails() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=6a1cabb5e93fd6605356ead9aa9712dd&language=en-US&append_to_response=credits`)
      .then((response) => {
      ...
      <div className="position-relative">
        ...
        <div className="backdrop-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center">
          <div className="container">
            <h1 className="text-white display-4 fw-bold mb-3">{movie.title}</h1>
            <div className="d-flex flex-wrap gap-3 mb-4">
              <span className="badge bg-primary">{movie.release_date.substring(0, 4)}</span>
